...
from genmech.robots.adjacency.sharpa_iiwa14 import SHARPA_IIWA14_ADJACENT_LINKS
...
def setup_scene(env) -> None:
    ...
    # M2 replaces this literal with env.robot_spec.adjacent_links.
    _apply_self_collision_filters(robot_converted_usd, SHARPA_IIWA14_ADJACENT_LINKS)

"""Browse any design from any iteration of the training-free design loop, in viser.
    ...
    .venv_isaacsim/bin/python -m genmech.tools.evolution_viewer --port 8090
...
class EvolutionViewer:
    ...
    def _show(self, slot: int) -> None:
        ...
        from genmech.robots.generated.population import hand_from_json
    ...
    def _describe(self, slot: int, hand) -> str:
        from genmech.robots.generated.mutate import phenotype

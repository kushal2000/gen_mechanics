r"""Train a genmech task with our vendored rl_games.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Train genmech task via rl_games.")
    # --- Task/agent selection ---
    parser.add_argument("--task", required=True, help="Gym task id, e.g. GenMech-PoseReach-Direct-v0")
    parser.add_argument(
        "--agent",
    ...
    parser.add_argument("--wandb_project", default="genmech")
    ...
    def run(env_cfg, agent_cfg: dict) -> None:
        ...
        if args_cli.capture_viewer:
            ...
            from genmech.viewer.pose_viewer import PoseViewerWrapper
        ...
        if args_cli.wandb_activate:
            from genmech.utils.wandb_utils import WandbAlgoObserver

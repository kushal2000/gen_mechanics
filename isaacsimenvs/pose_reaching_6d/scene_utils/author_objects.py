...
def _rigid_body_defaults(body_spec) -> None:
    ...
    from isaacsimenvs.pose_reaching_6d.scene_utils.author_usd import attr
...
def author_physics_material(layer, path: str, static_friction: float = 0.5,
    ...
    from isaacsimenvs.pose_reaching_6d.scene_utils.author_usd import attr, define
...
def author_handle_head(layer, prim_path: str, handle_scale, head_scale,
    ...
    from isaacsimenvs.pose_reaching_6d.scene_utils.author_usd import attr, define
    from isaacsimenvs.pose_reaching_6d.scene_utils.objects.generate_objects import (

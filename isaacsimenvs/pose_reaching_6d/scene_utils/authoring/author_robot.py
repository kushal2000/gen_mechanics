...
from isaacsimenvs.pose_reaching_6d.scene_utils.authoring.author_usd import (
    LINK_PARTS,
    PALM_BODY,
    attr,
    author_hand,
...
def arm_only_urdf(out_path: Path) -> Path:
    ...
    root.append(ET.Comment(
        " GENERATED by isaacsimenvs/pose_reaching_6d/scene_utils/authoring/author_robot.py.\n"

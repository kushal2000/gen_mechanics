...
which is what the co-design search needs (docs/proposal_codesign.md).
    ...
    .venv_isaacsim/bin/python -m hand_sampler.urdf --params sharpa_like
    .venv_isaacsim/bin/python -m hand_sampler.urdf --seed 3 --n_fingers 4
    .venv_isaacsim/bin/python -m hand_sampler.urdf --population 12 --seed 0
...
def build_urdf(hand: P.HandParams, *, mount_yaw: float | None = None) -> ET.Element:
    ...
    root.append(ET.Comment(
        f" GENERATED by hand_sampler/urdf.py; do not hand-edit.\n"
        f"     params: {hand.name}\n"
        ...
        f"             link masses (hand_sampler/sharpa_anchors.py).\n"
    ))

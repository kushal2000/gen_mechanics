...
can be rebuilt when a mount transform is retuned.
    ...
    .venv_isaacsim/bin/python -m hand_sampler.allegro_urdf
    .venv_isaacsim/bin/python -m hand_sampler.allegro_urdf --mount_yaw 0.7854
...
# Chosen by eye in isaacsimenvs/pose_reaching_6d/reachability_viewer.py, on the LEFT (mirrored)

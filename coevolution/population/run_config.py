...
* **Not copied**: goals, resets, termination, domain randomization. These are the
  eval PROTOCOL, and they come from ``coevolution/eval/suites.py`` so that results
...
def load_run_config(run_dir: Path):
    ...
    """
    from coevolution.eval import rl_player_utils  # noqa: F401  registers resolvers
...
def eval_protocol(dr_profile: str, goals_per_episode: int,
    ...
    """
    from coevolution.eval.suites import DR_PROFILES, NOMINAL, resolve_overrides
